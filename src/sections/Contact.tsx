...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative py-32 overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-br from-orange-200/20 to-transparent rounded-full blur-[100px] -z-10" />
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
                ...
                >
                    <div className="absolute top-0 right-0 w-32 h-32 bg-orange-100 rounded-bl-[100px] -z-0 opacity-50" />
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <input 
                                    ...
                                    className="w-full bg-gray-50 border border-gray-200 rounded-xl py-4 pl-12 pr-4 outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all"
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                <AtSign className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-orange-500 transition-colors" />
                                <input 
                                    type="email" 
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                <MessageCircle className="absolute left-4 top-6 w-5 h-5 text-gray-400 group-focus-within:text-orange-500 transition-colors" />
                                <textarea 
                                    value={formState.message}
                                    onChange={(e) => setFormState({...formState, message: e.target.value})}
                                    className="w-full bg-gray-50 border border-gray-200 rounded-xl py-4 pl-12 pr-4 min-h-[150px] outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all resize-none"
                        ...
                        <button 
                            type="submit"
                            className="w-full gradient-button text-white font-bold py-4 rounded-xl shadow-lg hover:shadow-orange-500/30 transition-all duration-300 flex items-center justify-center gap-2 group"
                        >
